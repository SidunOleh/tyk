<template>
    <a-flex
        ...
        <a-tooltip placement="right">
            ...
            <div 
                :style="{cursor: loading ? 'wait' : 'pointer', display: 'flex',}"
                @click="logout">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="black" height="14px" width="14px" version="1.1" id="Capa_1" viewBox="0 0 384.971 384.971" xml:space="preserve">
                    <g>
                        <g id="Sign_Out">
