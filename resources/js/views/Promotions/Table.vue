    ...
    <a-table
        ...
        <template #expandedRowRender="{ record }">
            <a-descriptions 
                ...
                <a-descriptions-item label="Загловок">
                    {{ record.title }}
                </a-descriptions-item>
                <a-descriptions-item label="Слаг">
                    {{ record.slug }}
                </a-descriptions-item>
                <a-descriptions-item label="Підзагловок">
                    {{ record.subtitle }}
                </a-descriptions-item>
            </a-descriptions>
        </template>
                ...
                <a-dropdown>
                    ...
                    <template #overlay>
                        <a-menu>
                            ...
                            <a-menu-item 
                                danger
                                @click="confirmPopup(() => deleteRecord(record), `Ви впевнені що хочете видалити ${record.title}?`)">
                                <a href="javascript:;">
                                    Видалити
                                </a>
                            </a-menu-item>
    ...
    methods: {
        ...
        doBulk() {
            if (
                ...
                confirmPopup(this.bulkDelete, 'Ви впевнені що хочете видалити обрані акції?')
            }
        },
    },
    watch: {
