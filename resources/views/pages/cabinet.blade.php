...
<section class="account">
    <div class="container">
        <div class="head">
            <h2 class="hero__title">Особистий кабінет</h2>
            <div class="bonuses title_20">Мої бонуси:<span> 0 грн</span></div>
        </div>
        <div class="account_List">
                ...
                <div class="content">
                    <div class="history-list">
                        <div class="history-item">
                            ...
                            <p class="position">Філе курки з картоплею пай та лісовими грибами</p>
                            <p class="adress">
                                м. Львів <br /> вул. Тараса Шевченка <br />буд. 5, кв 20
                            </p>
                            <p class="number">№3927</p>
                            <p class="sum-total">700.00₴</p>
                            <button class="btn">Повторити</button>
                        </div>
                        <div class="history-item">
                            <p class="date">12.12.2024</p>
                            <p class="position">Філе курки з картоплею пай та лісовими грибами</p>
                    ...
                    <div class="empty" style="display: none">Ви ще не зробили ні одного замовлення</div>
                </div>
            </div>
            ...
            />
                ...
                <div class="content">
                    <div class="pesonal-data">
                        <form action="">
                            <input type="text" name="name" placeholder="Ваше ім’я та прізвище*" />
                            <input type="text" name="phone" placeholder="Ваш номер телефону* " />
                            <input type="text" name="dob" placeholder="Дата вашого народження" />
                            <div class="buttons">
                                <button class="btn" type="button">Зберегти</button>
                                <button class="btn grey" type="reset">Відмінити</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="delivery-addressForm">
                        <form action="">
                            ...
                            <input type="text" name="street" placeholder="Назва вулиці та номер будинку*" />
                            <input type="text" name="apartment" placeholder="Квартира/офіс/блок (необов’язково)" />
                            <div class="buttons">
                                <button class="btn" type="button">Зберегти</button>
                                <button class="btn grey" type="reset">Відмінити</button>
                            </div>
                    ...
                    <div class="save-address">
                        <div class="addressData">
                            <div>
                                <span id="save-city">м. Львів</span>
                                <span id="save-street">вул. Тараса Шевченка</span>
                                <span id="save-apartment">буд. 5, кв 20</span>
                            </div>
                            <div class="edit">Редагувати</div>
                        </div>
                        <div class="addNew">+ Додати нову адресу</div>
                    </div>
                </div>
            </div>
            ...
            />
                ...
                <div class="content">
                    <div class="empty">Повідомлень не знайдено</div>
                </div>
            </div>
        </div>
        <div class="acc-nav">
            <div class="btn" id="logOut">Вихід</div>
            <div class="deleteAcc" id="deleteAcc">Видалити обліковий запис</div>
        </div>
    </div>
</section>
