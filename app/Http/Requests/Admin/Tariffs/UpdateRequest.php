...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'per_km' => 'required_if:fixed,'.Tariff::PER_KM.'|numeric|min:0|nullable',
    ...
    public function messages()
    {
        return [
            ...
            'fixed_up_to_km.required_if' => 'Поле фіксована ціна є обов\'язковим, коли тариф змішаний.',
            'per_km.required_if' => 'Поле за км є обов\'язковим, коли тариф за км.',
        ];
    }
}
